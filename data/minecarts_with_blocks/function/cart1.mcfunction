...
execute as @a if items entity @s player.cursor chest_minecart[custom_data~{better_vehicle_crafting:1b}] run function minecarts_with_blocks:cart2 {cart_type:"chest"}
...
execute as @a if items entity @s player.cursor furnace_minecart[custom_data~{better_vehicle_crafting:1b}] run function minecarts_with_blocks:cart2 {cart_type:"furnace"}
...
execute as @a if items entity @s player.cursor hopper_minecart[custom_data~{better_vehicle_crafting:1b}] run function minecarts_with_blocks:cart2 {cart_type:"hopper"}
...
execute as @a if items entity @s player.cursor tnt_minecart[custom_data~{better_vehicle_crafting:1b}] run function minecarts_with_blocks:cart2 {cart_type:"tnt"}
